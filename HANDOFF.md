...
- NeMo release archives use Metal on Apple Silicon and CPU on the current Linux and Windows packages. Keep NeMo's bundled C++ libraries out of build-time loader paths; they can shadow libclang dependencies.
